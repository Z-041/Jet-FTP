...
public class StorCommand extends BaseCommandHandler {
    ...
    public void handle(String argument, Session session, OutputStream out) throws IOException {
        ...
        executeWithDataConnection(
            ...
            dataSocket -> {
                ...
                session.getDataConnectionManager().receiveFile(
            ...
            "File receive: " + file.getAbsolutePath(),
            e -> {
                ...
                if (file.exists()) {
                    file.delete();
                    logger.info("Deleted incomplete file: " + file.getAbsolutePath());
                }
            }
        );
    }
